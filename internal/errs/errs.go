...
var (
	...
	ErrStopTooFarFromRoute = errors.New("one or more stops is too far from the route")
	ErrStopPastRouteEnd    = errors.New("one or more stops is past the driver's destination")
